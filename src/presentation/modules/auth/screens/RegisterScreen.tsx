...
export function RegisterScreen({ navigation }: Props) {
  ...
  const onSubmit = async (data: FormData) => {
    clearError();
    await register({ name: data.name, lastName: data.lastName, email: data.email, password: data.password });
  ...
  const fields: { name: keyof FormData; label: string; icon: string; secure?: boolean; keyboard?: any }[] = [
