  ...
  return (
    <KeyboardAvoidingView style={styles.flex} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
        ...
        {[
          { name: 'currentPassword' as const, label: 'Contraseña actual' },
          { name: 'newPassword' as const,     label: 'Nueva contraseña' },
          { name: 'confirmPassword' as const, label: 'Confirmar nueva contraseña' },
        ].map(f => (
