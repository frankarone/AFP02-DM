  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.grid}>
        ...
        {/* Registrar daño: solo administradores */}
        {isAdmin && (
        ...
        {/* Generar reportes: solo administradores */}
        {isAdmin && (
        ...
        {isAdmin && (
          <TouchableOpacity style={styles.card} onPress={administrarUsuarios}>
            <Ionicons name="people-outline" size={35} color="#16a085" />
            <Text style={styles.textoCard}>Administrar usuarios</Text>
          </TouchableOpacity>
        )}
